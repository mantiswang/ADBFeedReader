...
{
    NSURL *feedURL = [NSURL URLWithString:kADBFeedURL];
    
    // create the parser
    ADBFeedParser *feedParser = [[ADBFeedParser alloc] initWithURL:feedURL];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"FeedReader" withExtension:@"mom" subdirectory:@"FeedReader.momd"];
    __managedObjectModel = [[NSManagedObjectModel alloc] initWithContentsOfURL:modelURL];
    
    if (!__managedObjectModel) {
        NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"FeedReader" withExtension:@"momd"];
        __managedObjectModel = [[NSManagedObjectModel alloc] initWithContentsOfURL:modelURL];
    }
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"FeedReader.sqlite"];
    ...
    if (![__persistentStoreCoordinator addPersistentStoreWithType:NSSQLiteStoreType configuration:nil URL:storeURL options:nil error:&error]) {
        ...
        // Tip: if I get here, maybe the model has changed
        abort();
    }    
